...
enum {NVE, NVT, NPT, sNPT, iNPT, ensNR};
...
typedef struct
{
  ...
  int bboost_nrad;    /*number of allowed radical*/
  real bboost_Vmax;
  real bboost_P1;
  real bboost_q;
  ...
  int bias_con_de;
  int bias_con_de_n;
  int bias_con_de_atom1; /* center atom */
  int bias_con_de_atom2; /* bonded atom */
  int bias_con_de_interval;
  real bias_con_de_cutoff; /* bond order cut-off */
