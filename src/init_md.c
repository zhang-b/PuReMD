		       ...
		       static_storage *workspace, output_controls *out_control)
{
  ...
  if( out_control->energy_update_freq > 0 ) {
    ...
    fprintf( out_control->out, "%-6s%16s%16s%12s%16s%16s%16s%11s%11s%13s%13s%13s\n",
	     "step", "total energy", "poten. energy", "amd E", "delta. energy", "force. scale",
	     "kin. energy", "temp.", "target", "volume", "press.", "target" );
