...
#else
    fprintf( out_control->out, 
	     "%-6d%16.2f%16.2f%16.2f%10.2f%16.2f%16.2f%11.2f%11.2f%13.2f%13.5f%13.5f\n",
	     data->step, data->E_Tot, data->E_Pot, data->E_amd, data->E_amd_delta, data->F_amd_scale,
	     E_CONV*data->E_Kin, data->therm.T, control->T, system->box.volume, data->iso_bar.P,
	     (control->P[0] + control->P[1] + control->P[2])/3 );
    fprintf( out_control->pot, 
